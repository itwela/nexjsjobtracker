  ...
  return (
      ...
      <>
        <span onMouseUp={handlestate} className=" w-[80%] px-1  flex flex-col place-content-center mx-auto rounded-[0.5em] relative min-h-[8em] sm:min-h-[15vh] bg-mprimary ">
          ...
          <EvervaultCard text="Struggling to craft the perfect follow-up message?" text2=" Simply add a job and then click this box for a tailored message ready to send to a recruiter!" className=" text-main-w/70 hover:text-main-w" />
