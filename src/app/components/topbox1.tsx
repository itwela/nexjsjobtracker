...
export default function TopboxOne() {
  ...
  return (
      ...
      <>
        <span onMouseUp={handlestate} className="border w-[80%] px-2 py-2 hover:border-main-w/60  border-main-w/[0.2] flex flex-col items-start mx-auto rounded-[0.5em] relative h-[8em] sm:h-[15vh] bg-gradient-to-b from-gray-100/20 via-transparent to-transparent backdrop-blur-lg bg-opacity-75 ">
