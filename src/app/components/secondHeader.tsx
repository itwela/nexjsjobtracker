...
export default function Secondheader({userdata, userauth}: {userdata: any; userauth: any}) {
        ...
        <span className=''>
          ...
          <span className="w-[100vw] h-[10vh] fixed top-0 flex place-items-center z-10 place-content-center text-main-w">JobKompass</span>
            ...
            <Link href='/dashboard'>
              ...
              <span  className='flex justify-between gap-4  p-5 justify-between text-main-w hover:text-main-w  px-6 '>
